/**
 * PC专区导航下拉列表{"version":"https://res9.vmallres.com/shopdc/cdn/modules/nav-home/pc/js/1.3.10","time":"2018.05.30 14:39:17","author":"lwx564425/Guojun"}
 */
(function(window, $) {
    ...
    $navs.on({
        ...
        'mouseleave': function(e) {
            ...
            if (yy <= 10 && yy > 0 || (xx <= 10 && xx > 0 && currIndex == 0) || (xx2 <= 10 && xx2 > 0 && currIndex == navLen - 1)) {
                currNaverSubEl && currNaverSubEl.unbind('mouseleave');
                slideUp($naverSubs.children(), 300);
            } else {
                timer = setTimeout(function() {
                    currNaverSubEl && currNaverSubEl.unbind('mouseenter');
                    slideUp($naverSubs.children(), 300);
                }, 200);
            }
        }
