/**
 * PC轮播图
 * 优化：用JS的方式获取第一张图片的高度{"version":"https://res9.vmallres.com/shopdc/cdn/modules/slider-scroll/pc/js/1.2.20","time":"2017.12.01 11:46:51","author":"wwx355727/Ling"}
 * 修复：焦点会有两个重叠的，需要删除多余的初始化{"version":"https://res9.vmallres.com/shopdc/cdn/modules/slider-scroll/pc/js/1.2.16","time":"2018.07.11 15:42:47","author":"wwx355727/Ling"}
 */
(function(window, $, utils, undefined) {
    ...
    $.fn.slider = function(options) {
        ...
        this.each(function() {
            ...
            $(".ec-slider-nav span", obj).mouseenter(function() {
                _preIndex = index;
                index = $(this).index();
                showPics(index);
