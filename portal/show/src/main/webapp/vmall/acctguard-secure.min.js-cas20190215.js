	...
	function fingerprint(){
		...
		function getieplugins () {
			...
			if((Object.getOwnPropertyDescriptor && Object.getOwnPropertyDescriptor(window, "ActiveXObject")) || ("ActiveXObject" in window)) {
				var names = [
		          "https://hwid1.vmall.com/CAS/up/idmw_rss_29/js/pc_rss/secrisk/AcroPDF.PDF", // Adobe PDF reader 7+
		          "Adodb.Stream",
		          ...
		          "Skype.Detection",
		          "TDCCtl.TDCCtl",
		          "https://hwid1.vmall.com/CAS/up/idmw_rss_29/js/pc_rss/secrisk/WMPlayer.OCX", // Windows media player
