/**
 * PC端：数据上报
 * 优化：支持?和#{"version":"https://res9.vmallres.com/shopdc/cdn/modules/common/pc/js/1.2.20","time":"2017.12.14 10:04:26","author":"Ben"}
 * 新增：写入cps_track_id到cookie{"version":"https://res9.vmallres.com/shopdc/cdn/modules/common/pc/js/1.2.20","time":"2017.12.15 16:54:11","author":"Ben"}
...
ce.analytics = function(c) {
    ...
    if (c.bd) {
        ...
        switch (ce.url.getHost()) {
            case 'https://res9.vmallres.com/shopdc/cdn/modules/common/pc/js/www.vmall.com':
                key = 'a08b68724dd89d23017170634e85acd8';
                break;
            case 'https://res9.vmallres.com/shopdc/cdn/modules/common/pc/js/sale.vmall.com':
                key = '82d2186024cf7459f80be3ff94bea77f';
                break;
            case 'https://res9.vmallres.com/shopdc/cdn/modules/common/pc/js/mm.vmall.com':
    ...
    _paq.push(["setSiteId", (ce.url.getHost() || "https://res9.vmallres.com/shopdc/cdn/modules/common/pc/js/sale.vmall.com")]);
