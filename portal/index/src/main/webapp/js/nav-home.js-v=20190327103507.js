/**
 * PC首页导航
 * 转测{"version":"https://res9.vmallres.com/shopdc/cdn/modules/nav-home/pc/js/1.2.18","time":"2017.10.30 10:43:38","author":"hwx398008/Kun"}
 * update{"version":"https://res9.vmallres.com/shopdc/cdn/modules/nav-home/pc/js/1.3.10","time":"2018.6.5 9:55:38","author":"lwx564425/guojun"}
 */
(function(window, $, undefined) {
    ...
    window.search = function(c) {
        var b = $(c).find("#search-kw").val();
        if (!b) {
            return false;
        }
        b = $.trim(b);
        window.location.href = "https://res9.vmallres.com/search?keyword=" + encodeURIComponent(b);
        return false;
    };
})(window, jQuery);
